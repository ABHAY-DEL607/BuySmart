...
const Signup = () => {
    ...
    const handlePostLoginActions = (token) => {
        ...
        if (returnToExtension) {
            console.log('Detected signup from extension - will attempt to communicate back');
            ...
            try {
                ...
                if (window.opener && !window.opener.closed) {
                    ...
                    try {
                        ...
                        toast.success('Account created! This window will close in 3 seconds.');
                ...
                if (typeof chrome !== 'undefined' && chrome.runtime && chrome.runtime.sendMessage && EXTENSION_ID) {
                    ...
                    try {
                        chrome.runtime.sendMessage(EXTENSION_ID, {
                            ...
                            toast.success('Account created! You can now close this tab and return to the extension.');
                        ...
                        if (window.opener) {
                            ...
                            toast.success('Account created! You can now close this tab.');
                        } else {
                ...
                // Display token for manual use
                    ...
                    toast.success(`Account created! Please copy this token: ${token.substring(0, 15)}...`);
                }
            } catch (msgError) {
